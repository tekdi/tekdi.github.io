...
- You can use the `.pylintrc` file contents given below
- The `.pylintrc` content given below is taken from https://google.github.io/styleguide/pylintrc, with few modifications
