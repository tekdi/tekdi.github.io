...
Before setting up the LMS service, ensure you have the following prerequisites

### Prerequisites

- [Node.js] - Version 20 or later
- [NestJS] - Familiarity with NestJS framework
- [PostgreSQL] - Database for storing course and tracking data
...
Follow these steps to set up the LMS service on your local machine:
